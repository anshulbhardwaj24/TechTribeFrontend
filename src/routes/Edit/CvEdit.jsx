...
function CvEdit(props) {
        return ( 
            <div className='CvEdit '>
                <form className=''>
                    <section>
                        <h4 className='bg-red-400 bg-clip-text text-transparent font-bold section-title'>Personal Details</h4>
                    ...
                    <section>
                        <h4 className='bg-red-400 bg-clip-text text-transparent font-bold section-title'>Work Experience</h4>
                        {props.expItems.map((expItem)=>{
                            return (
                                <div className="work-exp-item" key={expItem.id}>
                                    ...
                                    <button type='button' className='bg-richblack-800 text-richblack-100 py-[8px]  px-[12px] border border-richblack-700 text-white hover:bg-red-400 hover:border-red-400 delete-work-exp-item' onClick={(e) => {
                                        e.preventDefault();
                        ...
                        <button type='button' className='bg-richblack-800 text-richblack-100 py-[8px]  px-[12px] border border-richblack-700 text-white hover:bg-red-400 hover:border-red-400 add-work-exp-item' onClick = {props.handleExperienceItemAdd}>Add</button>
                    </section>
                    
                    <section>
                        <h4 className='bg-red-400 bg-clip-text text-transparent font-bold section-title'>Education</h4>
                        {props.eduItems.map((eduItem)=>{
                            return (
                                <div className="edu-item" key={eduItem.id}>
                                    ...
                                    <button type='button' className='bg-richblack-800 text-richblack-100 py-[8px]  px-[12px] border border-richblack-700 text-white hover:bg-red-400 hover:border-red-400 delete-edu-item' onClick={(e) => {
                                        e.preventDefault();
                        ...
                        <button type='button' className='bg-richblack-800 text-richblack-100 py-[8px]  px-[12px] border border-richblack-700 text-white hover:bg-red-400 hover:border-red-400 add-edu-item' onClick={props.handleEducationItemAdd}>Add</button>
                    </section>
                    <section>
                        <h4 className='bg-red-400 bg-clip-text text-transparent font-bold section-title'>Personal Projects</h4>
                        {props.projItems.map((projItem)=>{
                            return (
                                <div className="proj-item" key={projItem.id}>
                                    ...
                                    <button type='button' className='bg-richblack-800 text-richblack-100 py-[8px]  px-[12px] border border-richblack-700 text-white hover:bg-red-400 hover:border-red-400 delete-proj-item' onClick={(e) => {
                                        e.preventDefault();
                        ...
                        <button type='button' className='bg-richblack-800 text-richblack-100 py-[8px]  px-[12px] border border-richblack-700 text-white hover:bg-red-400 hover:border-red-400 add-proj-item' onClick={props.handleProjItemAdd}>Add</button>
                    </section>
                </form>
            </div>
         );
