...
import phoneSvg from '../../components/assets/phone-square-solid.svg'
import emailSvg from '../../components/assets/envelope-square-solid.svg'
import mapMarkerSvg from '../../components/assets/map-marker-alt-solid.svg'
...
function CvPreview (props) {
        ...
        return ( 
            <div className='CvPreview border-white' ref={props.innerRef}>
                <div className="previewContent bg-white text-black">
                    <header>
